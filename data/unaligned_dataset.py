...
class UnalignedDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        # A_gray = 255.0-A_gray
        # resize_size = (320, 320)
        # A_img = A_img.resize(resize_size, Image.BICUBIC)
        # B_img = B_img.resize(resize_size, Image.BICUBIC)
